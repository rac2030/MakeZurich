...
<html lang="en" class=" is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Sensirion_SDP6x_pressure_sens/SDP6x.ino at master · EngineerTony/Sensirion_SDP6x_pressure_sens</title>
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTUxNDIzOTQyOmE4YWNiNGE3NjBhNWQxNTc4YWNjOGJmM2FhNjQ3OGRiM2RlNGYzNWY0MThjZWMxYmVhMmFmYzBiZDM0NjliNjU=--c4b513ffc79b6353fa18aa152bfe2aad3f776321">
    <meta name="pjax-timeout" content="1000">
    <link rel="sudo-modal" href="/sessions/sudo_modal">
    <meta name="request-id" content="C7D2:6A82:71DE19A:B150ADB:589463FD" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="C7D2:6A82:71DE19A:B150ADB:589463FD" name="octolytics-dimension-request_id" /><meta content="22455531" name="octolytics-actor-id" /><meta content="makatony" name="octolytics-actor-login" /><meta content="68f759d2f8fa3e8416ff928b049ff015f7ef734a3c5e8b87ebf8e9a9bc89d4f1" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="makatony">
      ...
      <meta name="js-proxy-site-detection-payload" content="">
  ...
  <link href="https://github.com/EngineerTony/Sensirion_SDP6x_pressure_sens/commits/master.atom" rel="alternate" title="Recent Commits to Sensirion_SDP6x_pressure_sens:master" type="application/atom+xml">
      ...
      <link rel="canonical" href="https://github.com/EngineerTony/Sensirion_SDP6x_pressure_sens/blob/master/SDP6x.ino" data-pjax-transient>
  </head>
  ...
  <li class="header-nav-item dropdown js-menu-container">
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="vMht1iMBQHYN8xOLN4eLFMLfn4mtWACAjCPN2s7R3qMfhZ/OxQ7pHuSsAqvaQ/s9x4ZCZkP3nyNrqadI0QG0lg==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="aQI7OajmZ3+kNcOJyDVhioO6CpKRaSu5CHFgCG7EBs8QfPwEjLx4VjMY8Du2Xtsi866nRvYP8S07Is7r5sliAA==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="61242930" />
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/EngineerTony/Sensirion_SDP6x_pressure_sens/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="TkSr9ELB0W7SPX9OAY507+3qFaPGJD3Cy63thD0rihHVi7NXum/2LxvVYH6jt6GZDXP6B+jnMaJp7CPmTYP1sA==" /></div>
      <button
        type="submit"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/EngineerTony/Sensirion_SDP6x_pressure_sens/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="fT6sFZnW/qNURJGdvLGlx1VD7xTD28mdlPdKXiHxRg/Gzl4talaKszvKgxJm6kprGcHqhR47NDINITdC3ljiCg==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/EngineerTony/Sensirion_SDP6x_pressure_sens/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ZZiMoPHmddT2wNlbwAGnrVpxk7j1pCuUkHmKEY8DgJF/s5Y1efPW4Tl0Xi+nkXxGgrwd/7UUrLfEqAdwmJg5jQ==" /></div>
            <button
                type="submit"
...
<a href="/EngineerTony/Sensirion_SDP6x_pressure_sens/blob/40407a9cdb4ed33108fc1678981e6152e006ec44/SDP6x.ino" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:bfbcd293284c1809dc4348fbc2b01382 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/EngineerTony/Sensirion_SDP6x_pressure_sens/blob/master/SDP6x.ino"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/EngineerTony/Sensirion_SDP6x_pressure_sens"><span>Sensirion_SDP6x_pressure_sens</span></a></span></span><span class="separator">/</span><strong class="final-path">SDP6x.ino</strong>
  </div>
</div>
...
<div class="file">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/EngineerTony/Sensirion_SDP6x_pressure_sens/raw/master/SDP6x.ino" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/EngineerTony/Sensirion_SDP6x_pressure_sens/blame/master/SDP6x.ino" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/EngineerTony/Sensirion_SDP6x_pressure_sens/commits/master/SDP6x.ino" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>

        <a class="btn-octicon tooltipped tooltipped-nw"
           href="github-windows://openRepo/https://github.com/EngineerTony/Sensirion_SDP6x_pressure_sens?branch=master&amp;filepath=SDP6x.ino"
           aria-label="Open this file in GitHub Desktop"
           data-ga-click="Repository, open with desktop, type:windows">
            <svg aria-hidden="true" class="octicon octicon-device-desktop" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M15 2H1c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1h5.34c-.25.61-.86 1.39-2.34 2h8c-1.48-.61-2.09-1.39-2.34-2H15c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1zm0 9H1V3h14v8z"/></svg>
        </a>

        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/EngineerTony/Sensirion_SDP6x_pressure_sens/edit/master/SDP6x.ino" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="yHK6eUQQfqQhzBl/nygg2dRsUJq0R5nmWMLSKdqP+xhrw12Prcy07hRlOSTVtvAC2pp+xkIZC3+P/aZDZI2Hlw==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/EngineerTony/Sensirion_SDP6x_pressure_sens/delete/master/SDP6x.ino" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="/H57dbhvsaXeBXR/x07rwV5NqGuIUFfM76s9+dPJXuR/g0ac1gbgUBg0jXCSllRej8EupAS9clCttgAJCaD4QQ==" /></div>
  ...
  <div itemprop="text" class="blob-wrapper data type-arduino">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * ReadSDP6x</span></td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> *  An example sketch that reads the sensor and prints the</span></td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> *  Differential Pressure to the PC&#39;s serial port</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> *  Tested with:</span></td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> *    - SDP600/610-125Pa (bought from FutureElectronics.com)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code blob-code-inner js-file-line">#<span class="pl-k">include</span> <span class="pl-s"><span class="pl-pds">&lt;</span>Wire.h<span class="pl-pds">&gt;</span></span></td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line">#<span class="pl-k">include</span> <span class="pl-s"><span class="pl-pds">&quot;</span>SDP6x.h<span class="pl-pds">&quot;</span></span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC13" class="blob-code blob-code-inner js-file-line"><span class="pl-k">float</span> difPressure;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC17" class="blob-code blob-code-inner js-file-line">  Wire.<span class="pl-c1">begin</span>();</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC19" class="blob-code blob-code-inner js-file-line">  difPressure = <span class="pl-c1">0.0</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC24" class="blob-code blob-code-inner js-file-line">  Serial.<span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Pressure Differential (Pa): <span class="pl-pds">&quot;</span></span>);</td>
      </tr>
      <tr>
        <td id="L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-code blob-code-inner js-file-line">  difPressure = SDP6x.<span class="pl-c1">GetPressureDiff</span>();</td>
      </tr>
      <tr>
        <td id="L26" class="blob-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-code blob-code-inner js-file-line">  Serial.<span class="pl-c1">print</span>(difPressure);</td>
      </tr>
      <tr>
        <td id="L27" class="blob-num js-line-number" data-line-number="27"></td>
        <td id="LC27" class="blob-code blob-code-inner js-file-line">  Serial.<span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>);</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.11592s from github-fe-3d613a9.cp1-iad.github.net">GitHub</span>, Inc.</li>
